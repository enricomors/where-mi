...
legend.onAdd = function (map) {
    ...
    div.innerHTML = '<label>Distance level</label><br><select id="distanceLevel" ><option value="4">MIN</option><option value="6">MEDIUM</option><option value="8">MAX</option></select>';
